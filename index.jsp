...
<body style = "background-image: url('https://cdn.wallpapersafari.com/94/73/t6DKUl.jpg');border: 1px solid rebeccapurple; opacity: 0.7;">

    
    <div class="mainContainer">
      <center><a href="index.html" trueblank="true" >Back</a></center> 
